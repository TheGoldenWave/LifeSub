...
> 遵循 `docs/testing-and-review-policy.md`。每项验收条件应声明变更类型、是否要求 RED/GREEN、验证层级、通过标准和证据。

- [ ] <!-- 验收条件 1 -->
- [ ] <!-- 验收条件 2 -->
- [ ] <!-- 验收条件 3 -->

| 验收条件 | 变更类型 | RED/GREEN | 验证层级 | 通过标准 | 证据/命令 |
|---|---|---|---|---|---|
| <!-- AC-1 --> | <!-- 行为/视觉/文档/配置/性能/真实环境 --> | <!-- 是/否/不适用 --> | <!-- 单元/集成/E2E/截图/构建/量化 --> | <!-- 明确阈值 --> | <!-- 路径或命令 --> |
