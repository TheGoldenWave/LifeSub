...
> 唯一集成/发布源：`/Users/goldenwave/.config/superpowers/worktrees/LifeSub/lifesub-real-asr-v0.2` / `codex/lifesub-real-asr-v0.2` / 暂停 HEAD `c68dc0d`。下一个允许开发的任务只有 Task 7，详见 `docs/handoffs/2026-08-21-lifesub-v0.2.1-native-capture-handoff.md`。
